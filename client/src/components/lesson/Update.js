...
import { success } from '../../actions/lesson/create';
import { retrieve, update, reset } from '../../actions/lesson/update';
...
const mapStateToProps = (state) => {
  return {
    retrieveError: state.lesson.update.retrieveError,
    retrieveLoading: state.lesson.update.retrieveLoading,
    updateError: state.lesson.update.updateError,
    updateLoading: state.lesson.update.updateLoading,
    deleteError: state.lesson.del.error,
    deleteLoading: state.lesson.del.loading,
    created: state.lesson.create.created,
    deleted: state.lesson.del.deleted,
    retrieved: state.lesson.update.retrieved,
    updated: state.lesson.update.updated,
  };
};
