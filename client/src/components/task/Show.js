...
import {retrieve, reset} from '../../actions/task/show';
...
class Show extends Component {
  ...
  render() {
    ...
    return <div>
      ...
      {item && <Link to={`/tasks/edit/${encodeURIComponent(item['@id'])}`}>
...
const mapStateToProps = (state) => {
  return {
    error: state.task.show.error,
    loading: state.task.show.loading,
    retrieved:state.task.show.retrieved,
