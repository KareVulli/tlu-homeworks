...
import { success } from '../../actions/task/create';
import { retrieve, update, reset } from '../../actions/task/update';
import { del, loading, error } from '../../actions/task/delete';
...
const mapStateToProps = (state) => {
  return {
    retrieveError: state.task.update.retrieveError,
    retrieveLoading: state.task.update.retrieveLoading,
    updateError: state.task.update.updateError,
    updateLoading: state.task.update.updateLoading,
    deleteError: state.task.del.error,
    deleteLoading: state.task.del.loading,
    created: state.task.create.created,
    deleted: state.task.del.deleted,
    retrieved: state.task.update.retrieved,
    updated: state.task.update.updated,
  };
};
