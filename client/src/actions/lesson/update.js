...
export function retrieveError(retrieveError) {
  return {type: 'LESSON_UPDATE_RETRIEVE_ERROR', retrieveError};
}

export function retrieveLoading(retrieveLoading) {
  return {type: 'LESSON_UPDATE_RETRIEVE_LOADING', retrieveLoading};
}

export function retrieveSuccess(retrieved) {
  return {type: 'LESSON_UPDATE_RETRIEVE_SUCCESS', retrieved};
}
...
export function updateError(updateError) {
  return {type: 'LESSON_UPDATE_UPDATE_ERROR', updateError};
}

export function updateLoading(updateLoading) {
  return {type: 'LESSON_UPDATE_UPDATE_LOADING', updateLoading};
}

export function updateSuccess(updated) {
  return {type: 'LESSON_UPDATE_UPDATE_SUCCESS', updated};
}
...
export function reset() {
  return {type: 'LESSON_UPDATE_RESET'};
}
