...
export function retrieveError(retrieveError) {
  return {type: 'TASK_UPDATE_RETRIEVE_ERROR', retrieveError};
}

export function retrieveLoading(retrieveLoading) {
  return {type: 'TASK_UPDATE_RETRIEVE_LOADING', retrieveLoading};
}

export function retrieveSuccess(retrieved) {
  return {type: 'TASK_UPDATE_RETRIEVE_SUCCESS', retrieved};
}
...
export function updateError(updateError) {
  return {type: 'TASK_UPDATE_UPDATE_ERROR', updateError};
}

export function updateLoading(updateLoading) {
  return {type: 'TASK_UPDATE_UPDATE_LOADING', updateLoading};
}

export function updateSuccess(updated) {
  return {type: 'TASK_UPDATE_UPDATE_SUCCESS', updated};
}
